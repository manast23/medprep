...
| Forensic Medicine | 91 / ~106 | 🔄 IN PROGRESS — subject card done. Subtopic plan corrected against the actual NRE 2023 syllabus (pages 24–28, verified July 2026) — 16 subtopics total, matching official topic list exactly. See Section 8 for full plan and progress. |
...
| 15 | Toxicology — General Principles | 5 | — | 🔄 Next |
